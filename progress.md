...
- ✅ Улучшена логика множественного выбора в фильтрах:
  ...
  - Создан метод getAttributeFiltersWithoutSelf для правильной обработки фильтров атрибутов
  - Каждый выбранный фильтр не влияет на доступность других значений того же атрибута
